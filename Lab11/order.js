function updateQuantityMessage(textbox) {
    let quantityMessage = document.getElementById('qty_textbook_message'); // Corrected ID
...
function displayPurchase() {
    let quantity = Number(document.getElementById('qty_textbook').value); // Corrected ID
    ...
    if (validationMessage === "") {
        ...
        document.getElementById('qty_textbook').value = ""; // Corrected ID
    }
}

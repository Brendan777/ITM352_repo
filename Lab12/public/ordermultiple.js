//order_multiple.js lab 12 part 6

window.onload = function(){

}
//Check the URL for any error parameters and and quatity and display use them
...
// in order to dynamically populate the form
const form = document.getElementById('productForm');
let formHTML = ''; //blank content of form to add to

//write a loop to print the product information AND then
// add a quantity text input box for every element of the
// product array
